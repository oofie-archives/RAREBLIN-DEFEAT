...
class PlayState extends MusicBeatState
{
	...
	override public function update(elapsed:Float)
	{
		...
		if(songMisses == howManyMisses && curSong.toLowerCase() == 'defeat') {
			health = 0;
		}
		...
		if (((skipHealthCheck && instakillOnMiss) || health <= 0) && !practiceMode && !isDead)
		{
			...
			if(ret != FunkinLua.Function_Stop) {
				...
				if(curSong.toLowerCase() != 'defeat'){
					...
					FlxG.sound.play(Paths.sound('edefeat', 'shared'), 1);
			...
			case 'defeat':
				switch (curStep)
				{
					...
					case 1328:
						...
						triggerEventNote('Change Character', '1', 'blackold');
					case 1600:
						FlxG.camera.flash();
						triggerEventNote('Change Character', '0', 'bf-defeat-scared');
						triggerEventNote('Change Character', '1', 'black');					
